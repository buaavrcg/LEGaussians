...
class CameraInfo(NamedTuple):
    ...
    width: int
    height: int
    language_feature_indices: np.array
...
def readColmapSceneInfo(path, images, eval, test_set, indices_path, llffhold=8):
    try:
    ...
    try:
        ...
        raise Exception("Could not find clip feature indices file. Please run the 'train_codebook.py' script in the preprocess first.")
    print("Loaded language feature indices.")
    ...
    if not os.path.exists(ply_path):
        ...
        try:
            ...
            try:
                ...
                # Since this data set has no point clouds data, we start with random points
                num_pts = 10_000
